                     ...
                     _In_ int       nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_CHATSERVERCLIENT, szWindowClass, MAX_LOADSTRING);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_CHATSERVERCLIENT));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_CHATSERVERCLIENT));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_CHATSERVERCLIENT);
	...
	/*case WM_KEYDOWN:
		{
			switch (wParam) {
			case VK_RETURN:
				char buff_getFromEdittext[1024];
				GetDlgItemTextA(hWnd, IDC_EDIT_TEXT, buff_getFromEdittext, sizeof(buff_getFromEdittext));
				SendDlgItemMessageA(hWnd, IDC_LIST_CLIENT, LB_ADDSTRING, 0, (LPARAM)buff_getFromEdittext);
				break;
			case VK_SHIFT:
    ...
    case WM_COMMAND:
        {
			...
			case IDC_BUTTON_SEND:
			{
				...
				char buff_toSendToListBox[1024] = "Send: ";
				GetDlgItemTextA(hWnd, IDC_EDIT_TEXT, buff_getFromEdittext, sizeof(buff_getFromEdittext));
